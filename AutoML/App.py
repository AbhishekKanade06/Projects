...
if st.session_state.df is not None:
    ...
    st.session_state.target_col = st.selectbox("🎯 Select Target Column", st.session_state.df.columns, key="st.session_state.target_col", index=(st.session_state.df.columns.get_loc(st.session_state.target_col) if st.session_state.target else 0))
else:
